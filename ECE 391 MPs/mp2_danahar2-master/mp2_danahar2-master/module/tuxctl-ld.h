...
// A line discipline is a driver that acts as a middle man between the serial port and the code you
// will implement to actually interpret the Tux controller commands
