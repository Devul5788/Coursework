...
class Agent():
    ...
    def object_detection(self, throttle, brake, steer, filtered_obstacles, transform, boundary):
        ...
        for i in range(len(filtered_obstacles)):
            ...
            for j in range(len(left)):
                ...
                if dist_l < min_dist_l:
                    min_dist_l = dist_l
                    min_left_dists[i] = (dist_l, diff_y_l, diff_x_l, x_cord, y_cord, j, dist)
        ...
        if (min_left_dists[0][6] <= min_dist_obstacle):
        ...
        if min_left_dists[0][0] >= vehicle_size:
            if (passed == 0):
        ...
        # multiple obstacles
            ...
            # go to the left
            elif min_left_dists[0][0] >= vehicle_size:
                next_obstacle = 0
                for i in range(len(filtered_obstacles)):
                ...
                if (passed == 0):
                    ...
                    avg_x = (min_left_dists[next_obstacle][3] + left[min_left_dists[next_obstacle][5]].transform.location.x)/2
            ...
            # go to the right
                ...
                if (passed == 0):
                    ...
                    avg_x = (min_right_dists[next_obstacle][3] + right[min_right_dists[next_obstacle][5]].transform.location.x)/2
