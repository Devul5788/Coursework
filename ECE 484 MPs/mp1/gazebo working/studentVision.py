...
class lanenet_detector():
	...
	def img_callback(self, data):
		...
		# bird_image, _, __ = self.perspective_transform(self.combinedBinaryImage(raw_img))
		# out_bird_msg = self.bridge.cv2_to_imgmsg(bird_image, '8UC1')
	...
	def color_thresh(self, img, thresh=(100, 255)):
		...
		# binary_output_h[(h_channel < 100)] = 255
	...
	def combinedBinaryImage(self, img):
		...
		## TODO
		# SobelOutput = self.gradient_thresh(img, 50, 100)
		# ColorOutput = self.color_thresh(img, (25, 255))
