...
class lanenet_detector():
    ...
    #         img_cuts_l[i] = img[(i * h//horizontal_cuts):((i+1) * h//horizontal_cuts), (0):(w//2)]
    #         #img_cuts_r[i] = img.crop((w/2, i * h/horizontal_cuts, w, (i+1) * h/horizontal_cuts))
    #         img_cuts_r[i] = img[(i * h//horizontal_cuts):((i+1) * h//horizontal_cuts), (w//2):(w)]
    ...
    #         ret2 = self.lane_fit(img_birdeye)
