...
def connect():
    ...
    return mdb.connect(host='localhost', user='ambala2', password='423510c156a3f2680ee62f3fff42ca1c05fa87b05551f18fa5130b5dfe1017cc', db='project2')
...
def createUser(username, password):
    ...
    # Refernce - Code example from https://pymysql.readthedocs.io/en/latest/user/examples.html
    sql = "INSERT INTO `users` (`username`, `password`, `passwordhash`) VALUES (%s, %s, %s)"
    cur.execute(sql, (username, password, password_hash))
