...
INNERLOOP   ADD   R5,R5,R1            ; Increment sum
            ...
            ST   R1,STOREDRES             ; This address contains X!          
            TRAP x25

INPUT      .FILL  x0005               ; Input for X!, in this case X = 5
ZERO       .FILL  x0000
MINUSONE   .FILL  xFFFF               ; 2's complement of 1 (i.e. -1)
STOREDRES  .FILL  x0000               ; At program completion, the result is
                                      ;   stored here
.END
