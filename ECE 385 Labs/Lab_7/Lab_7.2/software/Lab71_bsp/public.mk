...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../lab71.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x108
SOPC_SYSID_FLAG += --sidp=0x108
ELF_PATCH_FLAG  += --sidp 0x108

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1649399713
SOPC_SYSID_FLAG += --timestamp=1649399713
ELF_PATCH_FLAG  += --timestamp 1649399713
