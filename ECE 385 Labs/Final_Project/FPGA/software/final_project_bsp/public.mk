...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../final_project_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is final_project_soc
SOPC_NAME := final_project_soc
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1650569830
SOPC_SYSID_FLAG += --timestamp=1650569830
ELF_PATCH_FLAG  += --timestamp 1650569830
